...
The full source code can be found [here][3]. For more code examples, visit the
...
[![C++][5]][6](Native) [![Python][7]][8] [![Rust][9]][10] [![Julia][27]][28](third-party) [![Nim][29]][30](third-party)
